 ...
 *
 */
public class ApplyCouponMoreThan1000 extends BasePage {
...
//	private MobileElement CartButton;
	 ...
	 * @param driver
	 */
	public ApplyCouponMoreThan1000(AppiumDriver<WebElement> driver) {
		super(driver);
	}
	 ...
	 */
	public void doApplyCoupon(String p_user_id, String p_password, String S_text, String loc, String address, 
			String land, String code1, String code2, String code3, String code4, String S_data) throws InterruptedException {
		    		...
		    		else 
		    		{
		    			...
		    			else
		    			{
			    			...
			    			if (g.length()>2) 
			    			{
			    				...
			    				{
			    					Report("Cashback is fine Rs. " + h, "PASS");
								}
			    				else 
			    				{
			    					Report("Incorrect Cashback" + h, "FAIL");							
								}
							}
			    			else
			    			{
